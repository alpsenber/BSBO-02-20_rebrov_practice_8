package ru.mirea.rebrov.yandexmaps;
...
import ru.mirea.rebrov.yandexmaps.databinding.ActivityMainBinding;
...
// При получении координат местоположения устанавливается следующая иконка
        ...
        pinIcon.setIcon(
                "pin",
                ImageProvider.fromResource(this, R.drawable.baseline_accessible_forward_24),
